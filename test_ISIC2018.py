...
if __name__ == '__main__':
    ...
    for _data_name in ['test']:
        ...
        ##### put data_path here #####
        data_path = './data/ISIC2018/{}'.format(_data_name)
        ...
        get_metrics_and_print(np.asarray(gts), np.asarray(preds), method = method_name, testset = 'ISIC2018_'+_data_name, write = True)
